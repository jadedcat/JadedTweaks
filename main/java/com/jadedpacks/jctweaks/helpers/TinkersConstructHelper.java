...
private static void addRecipes() {
	...
	GameRegistry.addRecipe(new ShapelessOreRecipe((heart6), new Object[]
			{
			"EH", 
			"CX", 
	...
	GameRegistry.addRecipe(new ShapelessOreRecipe((heart2), new Object[]
			{
			"EH", 
			"CX", 
	...
	GameRegistry.addRecipe(new ShapelessOreRecipe((heart4), new Object[]
			{
			"EH", 
			"CX", 
